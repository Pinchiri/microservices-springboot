package com.rolando.accounts.constants;
...
public class AccountsConstants {
    ...
    public static final String  ADDRESS = "Calle F Caurimare, Caracas";
    ...
    public static final String  NUMBER_PATTERN_MSG = "Mobile number must be 10 digits";
